...
public function insert_cash_advance(){
	...
	public function request_leave(){
		$data = $this->andr_manager_model->get_employee_list();
		echo json_encode(array('status'=>true,'data'=>$data));
	}
...
$query = $this->andr_manager_model->document_uploads_update($doc_related,$doc_type,$doc_id,$user_name);
 ...
 public function cash_book_data(){
     ...
     {
       $user_id  = $_GET['user_id'];
       $user_details = $this->user_model->get_employee_details($user_id);
       //$leave_category_details = $this->common_hr_model->get_leave_category_details($user_details['leave_category']);

      //  $leave_type[0]="annual";
      //   $leave_type[1]="cassual";
      //   $leave_type[3]="sick";
      //   //$leave_type[4]="half_day";
      //   $leave_type[4]="short_leave";
      //   $leave_type[5]="no_pay";
      //   $leave_type[6]="maternity";
      //
      //  $leave_name["annual"]="Annual";
      //   $leave_name["cassual"]="Cassual";
      //   $leave_name["sick"]="Sick";
      // //  $leave_name["half_day"]=NULL;
      //   $leave_name["short_leave"]="Short Leave";
      //   $leave_name["no_pay"]="No Pay";
      //   $leave_name["maternity"]="Maternity Leave";

       $jsonleave[] = array('leave_type' =>'annual' ,'leave_name' =>'Annual');
        $jsonleave[]=array('leave_type' =>'cassual' ,'leave_name' =>'Cassual');
        $jsonleave[]=array('leave_type' =>'Sick' ,'leave_name' =>'Sick');
        //$jsonleave[]=array('leave_type' =>'half_day' ,'leave_name' =>'Half Day');
        //$leave_type[4]="half_day";
        $jsonleave[]=array('leave_type' =>'short_leave' ,'leave_name' =>'Short Leave');
        $jsonleave[]=array('leave_type' =>'no_pay' ,'leave_name' =>'No Pay');
        $jsonleave[]=array('leave_type' =>'maternity' ,'leave_name' =>'Maternity Leave');

       //$json['leave_types'] = $jsonleave;

       if($jsonleave){
         echo json_encode(array('status'=>true,'data'=>$jsonleave));
       }else{
         echo json_encode(array('status'=>false,'data'=>"Sorry This User Have Not Leave Types"));
       }
     }
     function leave_balance()
     {
       ...
       $user_details = $this->user_model->get_employee_details($user_id);
       $leave_category_details = $this->common_hr_model->get_leave_category_details($user_details['leave_category']);
       $active_user_leave_records= $this->user_model->get_user_active_leave_records($user_id);
       $system_pending_leave_records=$this->user_model->get_system_pending_leave_records($user_id);
       ...
       $jsonleave['entitled_annual_leave']=$entitled_annual_leave;
       $jsonleave['annual_leave_count']=$annual_leave_count;
       $jsonleave['remaining_annual_leave_count']=$remaining_annual_leave_count;

       $jsonleave['entitled_cassual_leave']=$entitled_cassual_leave;
       $jsonleave['cassual_leave_count']=$cassual_leave_count;
       $jsonleave['remaining_cassual_leave_count']=$remaining_cassual_leave_count;

       $jsonleave['entitled_sick_leave']=$entitled_sick_leave;
       $jsonleave['sick_leave_count']=$sick_leave_count;
       $jsonleave['remaining_sick_leave_count']=$remaining_sick_leave_count;

       $jsonleave['entitled_maternity_leave']=$entitled_maternity_leave;
       $jsonleave['maternity_leave_count']=$maternity_leave_count;
       $jsonleave['remaining_maternity_leave_count']=$remaining_maternity_leave_count;

       $jsonleave['nopay']=$no_pay_leave_count;
       $json['balanceleave'] = $jsonleave;

       $tot=$remaining_maternity_leave_count+$remaining_sick_leave_count+$remaining_cassual_leave_count+$remaining_annual_leave_count;
       if($tot>0){
         echo json_encode(array('status'=>true,'data'=>$jsonleave));
       }else{
         echo json_encode(array('status'=>false,'data'=>"Sorry You have not entitle for leave"));
       }
